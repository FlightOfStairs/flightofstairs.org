...
object CV extends CV("Alistair Smith", Messages("email"), "+447512853460",
    ...
    List(
      Work("Amazon.com", "Software Development Engineer", new YearMonth(2012, 7), None, List(
        "My current team is responsible for a customer-facing service with many performance and scalability challenges. I've learned to build and manage distributed systems and service oriented architectures to satisfy very low latency requirements. I've worked with big data analysis, in both an ongoing, systematic approach, as well as answering ad-hoc questions to drive specific business decisions.",
      "I've worked on innovative projects and prototypes in small sub-teams to open up new areas of business for Amazon, of which the best example is yet to be announced. I have a strong desire for high standards and there are many occasions where I've improved and simplified my team's world, either in my own time or by getting buy-in from other stakeholders.",
      "In addition to my primary responsibilities, I've been involved with other aspects of Amazon. I am very involved with recruitment and interviewing for the centre. I've taken ownership of several projects that are shared across teams in the centre, including externally facing websites and an app used to teach early secondary school children the basics of programming.")),
